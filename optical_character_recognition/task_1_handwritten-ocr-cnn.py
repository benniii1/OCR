...
n_cnn1planes = 10  # Set values between 10 and 100
n_cnn1kernel = 3
n_poolsize = 1
...
model_name = '../task_1_handwritten-ocr-cnn/CNN_Handwritten_OCR_CNN' + str(n_cnn1planes) + '_KERNEL' + \
             str(n_cnn1kernel) + '_Epochs' + str(n_epochs)
# figure_format='svg'
figure_format = 'png'
figure_path = '../task_1_handwritten-ocr-cnn/'
log_path = './log'
